      ...
      <div class="max-w-2xl mx-auto">
        <div class="grid sm:grid-cols-2 gap-6">
          ...
          <a
            ...
            class="group bg-white rounded-xl p-8 border border-cream-200/60 hover:shadow-md transition-all text-center"
          >
            <div class="w-14 h-14 rounded-full bg-sage-50 flex items-center justify-center mx-auto mb-4 group-hover:bg-sage-100 transition-colors">
